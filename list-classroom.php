...
<div class="row">
  <div class="col-xs-12">
    <div class="box">
      ...
      <div class="box-body"><a class="btn btn-success" href="add-classroom.php">Добавить аудиторию</a></div>
      <div class="box-body">
      <?php
      if ($classrooms) {
      ?>
      ...
      <table id="example2" class="table table-bordered table-hover">
        ...
        <tbody>
          ...
          <tr>
            <td><a href="view-classroom.php?id=<?= $classroom->classroom_id; ?>"><?= $classroom->name; ?></a>
